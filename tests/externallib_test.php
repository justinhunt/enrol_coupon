...
require_once($CFG->dirroot . '/enrol/coupon/externallib.php');

class enrol_coupon_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_instance_info() {
        ...
        $instanceinfo1 = enrol_coupon_external::get_instance_info($instanceid1);
        ...
        $instanceinfo2 = enrol_coupon_external::get_instance_info($instanceid2);
        ...
        $this->assertEquals(get_string('canntenrol', 'enrol_coupon'), $instanceinfo2['status']);
        $this->assertFalse(isset($instanceinfo2['enrolpassword']));

        $instanceinfo3 = enrol_coupon_external::get_instance_info($instanceid3);
        ...
        $this->assertEquals(get_string('password', 'enrol_coupon'), $instanceinfo3['enrolpassword']);
    }
}
