 ...
 * @category   phpunit
 * @copyright  2012 Petr Skoda {@link http://poodll.com}
...
class enrol_coupon_testcase extends advanced_testcase {

    public function test_basics() {
        $this->assertTrue(enrol_is_enabled('self'));
        $plugin = enrol_get_plugin('self');
        $this->assertInstanceOf('enrol_coupon_plugin', $plugin);
        $this->assertEquals(1, get_config('enrol_coupon', 'defaultenrol'));
        $this->assertEquals(ENROL_EXT_REMOVED_KEEP, get_config('enrol_coupon', 'expiredaction'));
    }
    ...
    public function test_longtimnosee() {
        ...
        $this->assertEquals(3, $DB->count_records('enrol', array('enrol'=>'coupon')));
        $instance1 = $DB->get_record('enrol', array('courseid'=>$course1->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        $instance2 = $DB->get_record('enrol', array('courseid'=>$course2->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        $instance3 = $DB->get_record('enrol', array('courseid'=>$course3->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
    ...
    public function test_send_expiry_notifications() {
        ...
        /** @var $selfplugin enrol_coupon_plugin */
        $selfplugin = enrol_get_plugin('self');
        ...
        $this->assertEquals(4, $DB->count_records('enrol', array('enrol'=>'coupon')));
        ...
        $instance4 = $DB->get_record('enrol', array('courseid'=>$course4->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
    ...
    public function test_show_enrolme_link() {
        ...
        // Cohort member test.
        $instance5 = $DB->get_record('enrol', array('courseid'=>$course5->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        ...
        $instance7 = $DB->get_record('enrol', array('courseid'=>$course6->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        ...
        $instance8 = $DB->get_record('enrol', array('courseid'=>$course7->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        ...
        $instance9 = $DB->get_record('enrol', array('courseid'=>$course8->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        ...
        $instance10 = $DB->get_record('enrol', array('courseid'=>$course9->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        ...
        $instance11 = $DB->get_record('enrol', array('courseid'=>$course10->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
        ...
        $instance12 = $DB->get_record('enrol', array('courseid'=>$course11->id, 'enrol'=>'coupon'), '*', MUST_EXIST);
    ...
    public function test_can_self_enrol() {
        ...
        $expectederrorstring = get_string('canntenrol', 'enrol_coupon');
