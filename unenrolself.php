...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'coupon'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/coupon/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_coupon', format_string($course->fullname));
